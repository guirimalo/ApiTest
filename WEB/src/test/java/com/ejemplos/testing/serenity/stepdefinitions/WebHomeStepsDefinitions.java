...
public class WebHomeStepsDefinitions {

	// HU 13 | TS 13.1 | TC 13.1.14 | mostrar Home desde Chrome
	...
	@Given("^El usuario quiere acceder a la pagina Home desde chrome$")
	public void el_usuario_quiere_acceder_a_la_pagina_home_desde_chrome() {
		System.out.println("Given");
	}

	@When("^el usuario accede a la pagina a traves de la URL LucAPI - Home$")
	public void el_usuario_accede_a_la_pagina_a_traves_de_la_url_luc_api_home() {
		System.out.println("When");
	}

	@Then("^se le muestra la informacion inicial de la pagina.$")
	public void se_le_muestra_la_informacion_inicial_de_la_pagina() {
		System.out.println("Then");
	}
